...
- **Загрузка файлов**: Документы и презентации
...
- **Аватары пользователей**: Загрузка и хранение фотографий профиля
- **Система приглашений**: Создание инвайт-ссылок для регистрации преподавателей
- **Поиск пользователей**: Поиск по email
...
- **POST** `/users/:id/avatar`
  - Требует авторизации
  - Multipart/form-data с полем `avatar`
...
- Ученики могут видеть только проекты своей школы и класса
